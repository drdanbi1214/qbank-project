...
// @version      0.1.8
// @description  Allen 문제·표와 원시험/교시/번호를 문제집 및 KMLE JSON용으로 모읍니다.
...
(function () {
  ...
  function extractSourceExamMeta(code = extractSourceTag(), title = document.title) {
  ...
  function extractFrontData() {
    ...
    const sourceMeta = extractSourceExamMeta(code);
    return {
